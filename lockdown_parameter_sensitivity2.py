...
experiment_values = [x / 10 for x in range(0, 11, 2)]
...
for experiment in experiment_values:
    ...
    trave_restr_mult = [experiment for x in range(len(age_groups))]
...
model_output.to_csv('{}experiment2_{}.csv'.format(data_folder, data_name))
