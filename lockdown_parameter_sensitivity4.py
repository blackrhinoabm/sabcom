...
# set likelihood awareness to 0.6 to activate
parameters['likelihood_awareness'] = 0.6

# run the experiment
pd_experiment = {}
for experiment in experiment_values:
    print('experiment: ', experiment)
    parameters["self_isolation_multiplier"] = experiment
    #print(parameters["self_isolation_multiplier"])
...
model_output.to_csv('{}experiment4_{}.csv'.format(data_folder, data_name))
